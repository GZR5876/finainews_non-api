# Sources — Finance: Peer Operators — Major Port Groups

`simple_query: AI finance technology automation port operator DP World APM COSCO Hutchison deployment [year] after:{period_start}`

High signal — any named finance AI deployment from this group scores at full value (8-10).
...
## Scoring notes
Apply +1 materiality bonus. Any disclosed AI finance deployment from a named port group scores 8-10. Capex and productivity disclosures score at full value.
