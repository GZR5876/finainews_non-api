# Sources — Physical AI: Key Players to Watch

HIGHEST PRIORITY — run these first.

---

### Port crane & terminal equipment

- https://www.kalmarglobal.com/news-and-insights/
  `search: site:kalmarglobal.com AI automation AGV port crane [year]`
- https://www.konecranes.com/media/
  `search: site:konecranes.com AI automation AGV port crane [year]`
- https://www.zpmc.com/news/
...
## Scoring notes
Score highest when tied to a named port deployment, quantified productivity gain, or capital procurement event. Equipment failures or safety incidents score high on narrative. Peer operator capex disclosures score at full value.
